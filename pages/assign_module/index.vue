    ...
    <v-row class="mt-5 mb-5">
      ...
      <v-col cols="6">
        <div class="text-right">
          <v-btn small color="primary" to="/assign_module/create" class="mb-2"
            >{{ Module }} +</v-btn
          >
        </div>
      </v-col>
...
export default {
  data: () => ({
    ...
    headers: [
        ...
        { text: "Company Id", align: "left", sortable: false, value: "company.id" },
        { text: "Company", align: "left", sortable: false, value: "company.name" },
        { text: "Modules", align: "left", sortable: false, value: "module_names" },
  ...
  methods: {
    ...
    editItem(item) {
      this.$router.push(`/assign_module/${item.id}`);
    }
  }
};
</script>
